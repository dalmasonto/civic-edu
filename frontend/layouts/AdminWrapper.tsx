...
import { IconDashboard, IconSettings, IconLogout, IconHome, IconForms, IconUsersGroup, IconReceipt, IconUpload, IconUserStar, IconStar, IconCategory, IconQuestionMark, IconArticle, IconLibrary, IconBuildingStore, IconShoppingBag, IconLocation } from '@tabler/icons-react';
