...
const CustomDataTable = (props: ICustomDataTable) => {
    const { url, method, defaultFilters, useNext, formValidators, columns, filterFields, updateData, hideUpdateActionBtn, extraActionButtons, hideDeleteActionBtn } = props
